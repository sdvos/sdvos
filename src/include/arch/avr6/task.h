...
/**
 * @file   src/include/arch/avr6/task.h
 * @author Ye Li (liye@sdvos.org)
 * @brief  AVR6 Task Management Utility
 */
#ifndef _AVR6_TASK_H_
#define _AVR6_TASK_H_
