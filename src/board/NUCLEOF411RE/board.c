...
/**
 * @file   board/NUCLEOF411RE/board.c
 * @author Ye Li (liye@sdvos.org)
 * @brief NUCLEOF411RE board specific configuration
 */
#include "board.h"
...
ClockInit (void)
{
  ...
  RCC->PLLCFGR = 0x10 /* PLLM 16 */ | 0x190 << 6 /* PLLN 400 */ |
  ...
  APB1Clock = 100000000 >> 1;
  /* Cortex Timer Clock = AHB Clock / 8 */
  SysTick_ONESEC = 100000000 >> 3;
}
